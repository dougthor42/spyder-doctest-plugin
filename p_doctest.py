...
from spyderplugins.widgets.doctestgui import DoctestWidget, DOCTEST_PATH


class DoctestConfigPage(PluginConfigPage):
    def setup_page(self):
        """
        ...
        results_label2 = QLabel(DoctestWidget.DATAPATH)
...
class Doctest(DoctestWidget, SpyderPluginMixin):
    """ doctest analysis of current file """
    CONF_SECTION = 'doctest'
    CONFIGWIDGET_CLASS = DoctestConfigPage

    def __init__(self, parent=None):
        DoctestWidget.__init__(self, parent=parent,
...
#        self.resultswidget.common_actions += (None, history_action)
    ...
    def register_plugin(self):
        ...
        doctest_act = create_action(self,
                                     _("Run code_doctest analysis"),
                                     triggered=self.run_doctest)
    ...
    def analyze(self, filename):
        ...
        DoctestWidget.analyze(self, filename)


#==============================================================================
# The following statements are required to register this 3rd party plugin:
#==============================================================================
PLUGIN_CLASS = Doctest
